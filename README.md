...
KOSIS OpenAPI에서 국내 밀가루/설탕 가격지수를 가져오고, FAO 공식 Food Price Index 페이지에서 최신 월별 국제 식량가격 CSV를 자동 탐색해 담합 의심 점수를 계산하는 Streamlit 웹앱입니다.
...
- 국내 밀가루/설탕: KOSIS OpenAPI
- 국제 곡물/설탕: FAO Food Price Index 공식 월별 CSV
